...
import { ChatlogicStyling, isSameSender } from "../ChatLogic/ChatstyleLogic";
...
const SERVER_POINT = "https://mateed.herokuapp.com";
                    ...
                    >
                        <div className={ChatlogicStyling(el.sender._id, user._id)}>
                            ...
                            <p className="time chat-time">
                                {new Date(el.createdAt).getHours() + ":" + new Date(el.createdAt).getMinutes()}
                            </p>

                        </div>
                        {isSameSender(messages, index) ? (
                            <Avatar src={el.sender._id != user._id ? el.sender.avatar : user.avatar} />
