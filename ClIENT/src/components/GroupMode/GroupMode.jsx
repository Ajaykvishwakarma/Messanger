...
import { LightTooltip } from '../Navbar/Navbar';
...
import { SearchUserComp } from '../MyChat/MyChat';
...
export const CustomizedDialogs = () => {
    ...
    return (
        <div >
        <LightTooltip title="New Groups" placement="right">
        ...
        >
          ...
          <DialogActions className="group_cont">
            <Button onClick={handleClose}>Cancel</Button>
            <ColorButton onClick={handleSubmit} >Create</ColorButton>
          </DialogActions>
        </BootstrapDialog>
      </div>
    );
