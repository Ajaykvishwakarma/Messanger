...
export const makeNewGroup = (group_data, token) => async (dispatch) => {
    recentLoding(true);
    const url = `https://mateed.herokuapp.com/chat/group`;
    try {
        let res = await fetch(url, {
          method: "POST",
